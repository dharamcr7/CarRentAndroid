...
public class CarRentalMainActivity extends AppCompatActivity {
    ...
    private void bundleData(){
        ...
        String userName = intent.getStringExtra("studentName");
       // noOfDayToRentCar.setText("Welcome  " +userName );
        Toast.makeText(CarRentalMainActivity.this,
